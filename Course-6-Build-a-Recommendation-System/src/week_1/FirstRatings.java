...
//        tmp.stream().map(week_1.FirstRatings::printRater).forEach(System.out::println);

        int id = 2;
        Rater r = tmp.get(id - 1);
        System.out.println("week_3.Rater whose id is " + id + " has rated " + getNumberOfRating(r) + " movies");
