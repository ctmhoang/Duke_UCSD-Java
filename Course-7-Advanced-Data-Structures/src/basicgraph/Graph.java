...
/**
 * An abstract class that implements a directed graph. The graph may have self-loops, parallel
 * edges. Vertices are labeled by integers 0 .. n-1 and may also have String labels. The edges of
 * the graph are not labeled. Representation of edges is left abstract.
 *
...
public abstract class Graph {
  ...
  /**
   * The degree sequence of a graph is a sorted (organized in numerical order from largest to
   * smallest, possibly with repetitions) list of the degrees of the vertices in the graph.
   *
   ...
   * @return A list of the vertices that can be reached in exactly two hops (by following two edges)
   *     from vertex v. TODO: Implement in part 2 of week 2 for each subclass of Graph
   */
...
//   * @param The String label of the vertex
  ...
  public static void main(String[] args) {
    //    GraphLoader.createIntersectionsFile(
    //        "data/maps/ucsd.map", "data/intersections/ucsd.intersections");
...
//     the correct list, after examining the graphs.
        ...
        System.out.println(graphAdjMatrix);

        System.out.println("Observe all degrees are <= 12.");
        System.out.println("****");

        System.out.println(graphFromFile.getDistance2(1));
        System.out.println(graphAdjMatrix.getDistance2(1));

        System.out.println("\n****");

//    System.out.println("UCSD Campus");
